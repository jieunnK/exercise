		...
		<div class="col-lg-15 col-md-15">
			...
			<form:form commandName="dataVO" name="dataVO" action="/notice/${mode}/action.do" method="post" novalidate="novalidate">
				...
				<div class="col-md-9 form-group p_star">
					<form:input path="dataTitle" class="form-control" id="dataTtle"
				...
				<div class="col-md-2 form-group p_star">
					<div class="radion_btn">
						<form:radiobutton path="boardDivision" id="boardDivision"
							value="1" onchange="objChg(this.value);"/>
				...
				<div class="col-md-2 form-group p_star">
					<div class="radion_btn">
						<form:radiobutton path="boardDivision" id="boardDivision2"
							value="2" onchange="objChg(this.value);"/>
				...
				<div id="noticeDivision" style="display: none;">
					...
					<div class="col-md-2 form-group p_star">
						<form:input path="beginDateStr" class="form-control" id="beginDateStr"
							placeholder="시작날짜." onClick="showCalendar('beginDateStr');" />
					</div>
					<div class="col-md-1 form-group p_star" style="text-align: center;">
						~</div>
					<div class="col-md-2 form-group p_star">
						<form:input path="endDateStr" class="form-control" id="endDateStr"
							placeholder="종료날짜." onClick="showCalendar('endDateStr');"/>
					</div>
				...
				<div class="col-md-12 form-group p_star">
					<form:textarea path="dataContent" class="form-control" id="dataContent" rows="1"
						placeholder="내용을 입력해주세요."
						style="margin-top: 15px; margin-bottom: 0px; height: 359px;" />
